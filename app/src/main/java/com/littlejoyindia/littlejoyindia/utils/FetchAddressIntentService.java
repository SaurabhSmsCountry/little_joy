...
public class FetchAddressIntentService extends IntentService {
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
          ...
          //  bundle.putString(AppUtils.LocationConstants.LOCATION_DATA_PIN_CODE, address.getPostalCode());
           // bundle.putString(AppUtils.LocationConstants.LOCATION_DATA_AREA, address.getFeatureName());
          //  bundle.putString(AppUtils.LocationConstants.LOCATION_State, address.getAdminArea());
         //   bundle.putString(AppUtils.LocationConstants.LOCATION_district, address.getSubAdminArea());
          //  bundle.putString(AppUtils.LocationConstants.LOCATION_DATA_CITY, address.getLocality());
        //    bundle.putString(AppUtils.LocationConstants.LOCATION_DATA_STREET, address.getPremises());
