...
public class DealsAdapter extends RecyclerView.Adapter<DealsAdapter.VH> {
    ...
    List<DealsResponse.Data> data;
    private Context context;
    Integer status;
    //success = 1; cancelled = 2; failed = 0;
    public DealsAdapter(List<DealsResponse.Data> data, Integer status, OnOrderItemClick listener) {
        this.data = data;
        this.status = status;
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new VH(LayoutInflater.from(parent.getContext()).inflate(R.layout.deal_item, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        try {
            date = inputFormat.parse(data.get(position).getCreated_at());
        ...
        holder.tvAmount.setText("\u20B9"+data.get(position).getPaid_amount());
        String mode;
